...
class TestTortoiseInit:
    ...
    def test_init_tortoise_without_exception_handlers(self):
        ...
        with patch("nexios_contrib.tortoise.TortoiseClient"):
            with patch(
                "nexios_contrib.tortoise.handle_tortoise_exceptions"
            ) as mock_handle:
                init_tortoise(
                    app, db_url="sqlite://:memory:", add_exception_handlers=False
                )
    ...
    def test_init_tortoise_with_exception_handlers(self):
        ...
        with patch("nexios_contrib.tortoise.TortoiseClient"):
            with patch(
                ...
                init_tortoise(
                    app, db_url="sqlite://:memory:", add_exception_handlers=True
                )
