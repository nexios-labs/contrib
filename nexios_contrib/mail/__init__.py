...
def setup_mail(app: NexiosApp, config: Optional[MailConfig] = None) -> MailClient:
    ...
    if not hasattr(app, "mail_client"):
        ...
        app.mail_client = mail_client  # ty:ignore[invalid-assignment]
    ...
    return app.mail_client  # ty:ignore[unresolved-attribute]
